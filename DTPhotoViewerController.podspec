...
Pod::Spec.new do |s|
  ...
  s.version          = "0.0.1"
  s.summary          = "A short description of DTPhotoViewerController."
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/DTPhotoViewerController"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Tung Vo" => "tung98.dn@gmail.com" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/DTPhotoViewerController.git", :tag => s.version.to_s }
